...
L:"ytp-mdx-popup-dialog",W:{role:"dialog"},U:[{G:"div",L:"ytp-mdx-popup-dialog-inner-content",U:[{G:"div",L:"ytp-mdx-popup-title",qa:"Du bist nicht angemeldet"},{G:"div",L:"ytp-mdx-popup-description",qa:"Videos, die du dir ansiehst, werden m\u00f6glicherweise zum TV-Wiedergabeverlauf hinzugef\u00fcgt und k\u00f6nnen sich damit auf deine TV-Empfehlungen auswirken. Melde dich auf einem Computer in YouTube an, um das zu vermeiden."},{G:"div",L:"ytp-mdx-privacy-popup-buttons",U:[{G:"button",Ha:["ytp-button",
"ytp-mdx-privacy-popup-cancel"],qa:"Abbrechen"},{G:"button",Ha:["ytp-button","ytp-mdx-privacy-popup-confirm"],qa:"Best\u00e4tigen"}]}]}]});this.j=new g.DJ(this,250);this.cancelButton=this.Da("ytp-mdx-privacy-popup-cancel");this.confirmButton=this.Da("ytp-mdx-privacy-popup-confirm");g.K(this,this.j);this.T(this.cancelButton,"click",this.u);this.T(this.confirmButton,"click",this.B)},N9=function(a){g.W.call(this,{G:"div",
...
b=g.V(b,128)?g.qG("Fehler auf $RECEIVER_NAME",c):b.Jc()||g.V(b,4)?g.qG("Wiedergabe \u00fcber $RECEIVER_NAME",c):g.qG("Verbunden mit $RECEIVER_NAME",c);a.Ma("statustext",b);a.j.show()}else a.j.hide()},O9=function(a,b){g.zP.call(this,"Wiedergeben auf",0,a,b);
...
this.vl={key:v6(),name:"Dieser Computer"};this.Ai=null;this.subscriptions=[];this.mH=this.dc=null;this.ip=[this.vl];this.Rn=this.vl;this.Jd=new g.WH(64);this.lN=0;this.Ff=-1;this.Ox=!1;this.Mx=this.nu=null;if(!g.hD(this.player.V())&&!g.iD(this.player.V())){a=this.player;var b=g.WL(a);b&&(b=b.Do())&&(b=new O9(a,b),g.K(this,b));b=new N9(a);g.K(this,b);g.fM(a,b.element,4);this.nu=new M9;g.K(this,this.nu);g.fM(a,this.nu.element,4);this.Ox=!!w9()}},Q9=function(a){a.Mx&&(a.player.removeEventListener("presentingplayerstatechange",
...
O9.prototype.Cj=function(a){return"cast-selector-receiver"===a?"Streamen\u2026":this.ip[a].name};
